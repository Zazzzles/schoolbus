...
const description =
  'Magna laboris sit consectetur nulla. Fugiat commodo anim amet consectetur et amet sint reprehenderit mollit aliqua.'
...
export default {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'The card component provides a flexible and extensible content container with multiple ' +
...
Base.args = {
  ...
  description:
    'This is the description. Consectetur id ipsum ex adipisicing. Occaecat incididunt tempor sit amet laboris eiusmod eu ullamco.',
  onAdd: console.log,
  actions: '',
  viewState: true,
  hideDivider: false,
